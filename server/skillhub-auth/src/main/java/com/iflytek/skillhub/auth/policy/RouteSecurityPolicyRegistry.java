...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.authenticated(null, "/api/mcp"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skill-bundles"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skill-bundles/*/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skill-bundles/*/*/download"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skill-bundles"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skill-bundles/*/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skill-bundles/*/*/download"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/skill-bundles"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/v1/skill-bundles/*/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/web/skill-bundles"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.PUT, "/api/web/skill-bundles/*/*"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skills/**"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/skill-bundles"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/skill-bundles/**"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skill-bundles"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/skill-bundles/**"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/namespaces"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/v1/namespaces/*"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/namespaces"),
            ApiTokenPolicy.allow(HttpMethod.GET, "/api/web/namespaces/*"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/mcp/servers", "mcp:read"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/mcp/internal-servers", "mcp:read"),
            ...
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/skill-bundles", "skill:publish"),
            ApiTokenPolicy.require(HttpMethod.PUT, "/api/v1/skill-bundles/*/*", "skill:publish"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/web/skill-bundles", "skill:publish"),
            ApiTokenPolicy.require(HttpMethod.PUT, "/api/web/skill-bundles/*/*", "skill:publish"),
