...
export const APP_HEADER_BASE_CLASS_NAME =
  'sticky top-0 z-50 flex h-[68px] items-center justify-between gap-2 bg-white px-3 transition-shadow duration-200 sm:gap-3 sm:px-6 xl:px-10 2xl:px-20 shadow-[0_2px_4px_rgba(0,0,0,0.05)]'
