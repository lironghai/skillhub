...
export function PublishPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-fade-up">
      ...
      <Card className="p-4 bg-brand-light border-blue-500/20" >
        <div className="flex items-start gap-3">
          <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{color:"hsla(19, 84%, 56%, 1)"}}>
