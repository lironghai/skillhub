...
: "${SKILLHUB_CONTEXT_FORGE_ADMIN_URL:=/contextforge/admin/login}"
...
export \
  SKILLHUB_WEB_API_BASE_URL \
  SKILLHUB_PUBLIC_BASE_URL \
  SKILLHUB_CONTEXT_FORGE_ADMIN_URL \
...
envsubst '${SKILLHUB_WEB_API_BASE_URL} ${SKILLHUB_PUBLIC_BASE_URL} ${SKILLHUB_CONTEXT_FORGE_ADMIN_URL} ${SKILLHUB_WEB_AUTH_DIRECT_ENABLED} ${SKILLHUB_WEB_AUTH_DIRECT_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_ENABLED} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_PROVIDER} ${SKILLHUB_WEB_AUTH_SESSION_BOOTSTRAP_AUTO}' \
